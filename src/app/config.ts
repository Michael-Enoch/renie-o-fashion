...
export const BUSINESS = {
  name: envString("VITE_BUSINESS_NAME", "Renie O Fashion"),
  tagline: "Luxury Womenswear · Port Harcourt",
  location: envString("VITE_BUSINESS_LOCATION", "Port Harcourt, Rivers State, Nigeria"),
  instagram: envString("VITE_INSTAGRAM_HANDLE", "renie_o_fashion"),
  instagramUrl: envString("VITE_INSTAGRAM_URL", "https://www.instagram.com/renie_o_fashion/"),
...
export const WA = {
  general: () =>
    BUSINESS.whatsappLink("Hi Renie O Fashion! I'd like to learn more about your collections."),

  bridal: (productName: string, price: number) =>
    BUSINESS.whatsappLink(
      `Hi Renie O Fashion! I'd like to book a bridal consultation for:\n\n*${productName}*\nStarting from ${formatPrice(price)}\n\nPlease share your availability and next steps.`
    ),

  bespoke: (productName: string, price: number) =>
    BUSINESS.whatsappLink(
      `Hi Renie O Fashion! I'd like to commission a bespoke piece:\n\n*${productName}*\nBudget reference: ${formatPrice(price)}+\n\nI'd love to discuss my vision and measurements.`
    ),

  order: (productName: string, price: number, size: string, category: string) =>
    BUSINESS.whatsappLink(
      `Hi Renie O Fashion! I'd like to order:\n\n*${productName}* (${category})\nSize: ${size}\nPrice: ${formatPrice(price)}\n\nPlease confirm availability and delivery details.`
    ),

  cart: (lines: string, total: number) =>
    BUSINESS.whatsappLink(
      `Hi Renie O Fashion! I'd like to place an order:\n\n${lines}\n\n*Total: ${formatPrice(total)}*\n\nPlease confirm availability and delivery details.`
    ),

  academy: () =>
    BUSINESS.whatsappLink(
      "Hi Renie O! I'm interested in your fashion classes. Please share available courses and fees."
    ),

  bridalConsult: () =>
    BUSINESS.whatsappLink(
      "Hi Renie O Fashion! I'd like to book a bridal consultation. Please share your availability."
    ),

  bespokeConsult: () =>
    BUSINESS.whatsappLink(
      "Hi Renie O Fashion! I'd like to start a bespoke order. Please share next steps."
    ),
};
